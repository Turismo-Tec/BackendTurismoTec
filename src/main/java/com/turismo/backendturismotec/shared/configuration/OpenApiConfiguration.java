...
public class OpenApiConfiguration {
   @Bean
    public OpenAPI customOpenApi(
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("Turismo Tec API")
                        .version(applicationVersion)
                        .description(applicationDescription)
                        .termsOfService("https://turimo-tec.com/tos")
                        .license(new License().name("Apache 2.0 License").url("https://turismo-tec.com/license"))
                        .contact(new Contact()
                                .url("https://turismo-tec.studio")
                                .name("Turismo Tec")));
    }
}
